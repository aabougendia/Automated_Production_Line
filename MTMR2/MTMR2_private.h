...
#ifndef MTMR2_PRIVATE_H_
#define MTMR2_PRIVATE_H_
...
#define PRIVATE_TMR2_MODE_NORMAL															0b00000000
#define PRIVATE_TMR2_MODE_PHASE_CORRECT_PWM													0b01000000
#define PRIVATE_TMR2_MODE_CTC																0b00001000
#define PRIVATE_TMR2_MODE_FAST_PWM															0b01001000

#define PRIVATE_TMR2_NON_PWM_CM_OUTPUT_MODE_OC2_DISCONNECTED								0b00000000
#define PRIVATE_TMR2_NON_PWM_CM_OUTPUT_MODE_TOGGLE_OC2_ON_CM								0b00010000
#define PRIVATE_TMR2_NON_PWM_CM_OUTPUT_MODE_CLEAR_OC2_ON_CM									0b00100000
#define PRIVATE_TMR2_NON_PWM_CM_OUTPUT_MODE_SET_OC2_ON_CM									0b00110000

#define PRIVATE_TMR2_FAST_PWM_CM_OUTPUT_MODE_OC2_DISCONNECTED								0b00000000
#define PRIVATE_TMR2_FAST_PWM_CM_OUTPUT_MODE_RESERVED										0b00010000
#define PRIVATE_TMR2_FAST_PWM_CM_OUTPUT_MODE_OC2_CLR_ON_CM_SET_AT_TOP						0b00100000
#define PRIVATE_TMR2_FAST_PWM_CM_OUTPUT_MODE_OC2_SET_ON_CM_CLR_AT_TOP						0b00110000

#define PRIVATE_TMR2_PHASE_CORRECT_PWM_CM_OUTPUT_MODE_OC2_DISCONNECTED						0b00000000
#define PRIVATE_TMR2_PHASE_CORRECT_PWM_CM_OUTPUT_MODE_RESERVED								0b00010000
#define PRIVATE_TMR2_PHASE_CORRECT_PWM_CM_OUTPUT_MODE_OC2_CLR_UP_SET_DOWN					0b00100000
#define PRIVATE_TMR2_PHASE_CORRECT_PWM_CM_OUTPUT_MODE_OC2_SET_UP_CLR_DOWN					0b00110000




#define PRIVATE_TMR2_CLK_NO_CLK_SRC															0b00000000
#define PRIVATE_TMR2_CLK_NO_PRESCALER														0b00000001
#define PRIVATE_TMR2_CLK_PRESCALER_8														0b00000010
#define PRIVATE_TMR2_CLK_PRESCALER_32														0b00000011
#define PRIVATE_TMR2_CLK_PRESCALER_64														0b00000100
#define PRIVATE_TMR2_CLK_PRESCALER_128														0b00000101
#define PRIVATE_TMR2_CLK_PRESCALER_256														0b00000110
#define PRIVATE_TMR2_CLK_PRESCALER_1024 													0b00000111



#endif /* MTMR2_PRIVATE_H_ */
